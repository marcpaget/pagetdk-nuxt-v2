...
export default defineNuxtConfig({
 ...
 "@vueuse/nuxt", '@nuxtjs/mdc', // UI framework - load after content modules
 'nuxt-toc', // External service integrations
 '@nuxt/content', '@nuxt/ui', "@nuxt/image", "@nuxtjs/supabase", // Map modules
 'nuxt-api-party', // PWA should be last to wrap everything
 'nuxt-umami', //'@vite-pwa/nuxt',
 "nuxt-mapbox", "@nuxtjs/leaflet", '@nuxt/scripts', '@compodium/nuxt', '@sentry/nuxt/module'],
